...
Начиная с [версии 0.2.0](https://github.com/klekot/rusprice/tree/v0.2.0) не надо создавать экземпляры **RusPrice::Converter**, достаточно вызвать метод "rusprice" на любом числе в вашем коде.
